    ...
    <div class="banner">
      ...
      <div class="target">
        <div class="summary">
            ...
            <div class="para">
            <p>ExpenseNG tracks federal spending to ensure taxpayers can </p>
            <p>see how their money is being used in communities across </p>
            <p> Nigeria.Learn more on how this money was spent with</p>
  ...
  @section('content')
    <section id="main">     
       ...
       <div class="explore">
           ...
           <p>Use our explorer to view how government spends our <br> money daily</p>
           <button>Explore</button>
       </div>

       <!-- Company section -->
       <p class="label" id="compu">Companies that received money</p>
       <div class="companies">
            <div class="comp-card">
               <div class="awarded">
                <div class="graph-cont">
