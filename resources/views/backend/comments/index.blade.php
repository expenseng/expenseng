                                ...
                                <tbody>
                                 ...
                                 @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td>
                                            @can('edit')
                                            <a href="{{'/admin/users/edit/' . $comment['refId']}}"><i class="fa fa-edit" style="color: #00945E"></i></a>
                                            @endcan
                                            @can('delete')
                                            <form method="POST" style="display: inline-flex;" action="{{'/admin/users/delete/'. $comment['refId']}}">
                                               @method('delete')
                                                @csrf
