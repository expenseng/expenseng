        ...
        if ($validator->passes()) {
            ...
            if ($sheet_type == 'company') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'data not save, ensure the file is well arranged,also ensure that each person has a unique name and shortname in data base ',
                            ],
                        ]);
                }
                return redirect()
            ...
            if ($sheet_type == 'budget') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'data not save, ensure the file is well arranged,also ensure that each person has a unique code ',
                            ],
                        ]);
                }
            ...
            if ($sheet_type == 'payment') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'data not save, ensure the file is well arranged ,also ensure that each person has a unique paymant code',
                            ],
                        ]);
                }
                // return back()-> withStatus('saved');
            ...
            if ($sheet_type == 'ministry') {
                ...
                return redirect()
                    ->back()
                    ->with([
                        'success' => 'ministry file uploaded successfully',
                    ]);
            }
            if ($sheet_type == 'cabinet') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'data not save, ensure the file is well arranged, also ensure that each person has a unique ministry code',
                            ],
                        ]);
                }
            ...
            if ($sheet_type == 'people') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'Data not saved, ensure the file is well arranged, also ensure that each person has a unique company id ',
                            ],
                        ]);
                }
                return redirect()
            ...
            if ($sheet_type == 'sector') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'sector file not uploaded, please check the file format',
                            ],
                        ]);
                }
                // return back()-> withStatus('saved');
            ...
            if ($sheet_type == 'expense') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'Data not saved, ensure the file is well arranged or does not exist in the data base ',
                            ],
                        ]);
                }
                // return back()-> withStatus('saved');
            ...
            if ($sheet_type == 'citizen') {
                ...
                try {
                    ...
                    return redirect()
                        ...
                        ->with([
                            'errors' => [
                                'invalid file format , please provide the file for Citizen',
                            ],
                        ]);
                }
